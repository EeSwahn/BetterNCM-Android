...
<p align="center">
    <b>A buttery-smooth, high-resolution dynamic-lyrics experience built on the NetEase Cloud Music API.</b>
    <br>
    ⚠️ 仅供个人学习与研究所用 · For personal learning & research only.
</p>
...
[![Kotlin](<https://img.shields.io/badge/UI-Jetpack%20Compose-red>)](#) [![Media3](<https://img.shields.io/badge/Playback-Media3%20%2F%20ExoPlayer-green>)](#) [![Retrofit](<https://img.shields.io/badge/Network-Retrofit%20%2F%20OkHttp-blue>)](#) [![Coil](https://img.shields.io/badge/Images-Coil-orange)](#) [![MVVM](<https://img.shields.io/badge/Arch-MVVM%20%2B%20StateFlow-purple>)](#)
...
- **Screenshot:** see the banner above (`assets/preview.png`).
- **Preview video (Bilibili):** [https://www.bilibili.com/video/BV1VUbA6uExY/](https://www.bilibili.com/video/BV1VUbA6uExY/)
...
- The "NetEase Cloud Music" APIs, logos and assets used by this project are the property of NetEase, Inc.
- This project is **for personal learning & research only** and must **not** be used for any commercial purpose.
...
- **界面截图**：见上方横幅图（`assets/preview.png`）。
- **预览视频（Bilibili）**：[https://www.bilibili.com/video/BV1VUbA6uExY/](https://www.bilibili.com/video/BV1VUbA6uExY/)
...
<details>
<summary><b>免责声明与版权说明</b></summary>

- 本项目所使用的“网易云音乐”相关 API、Logo 及素材版权归网易公司所有。
- 本项目**仅供个人学习和研究使用**，**严禁用于任何商业目的**。
